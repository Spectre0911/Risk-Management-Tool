    ...
    <div className='bugContainer'>      
        <div className="bugLeftPane"> 
            ...
            <div className="bugFeature">
                ...
                <div className="bugFeatureLocation"><p>{data.bugLocation}</p></div>
            </div>
            <div className="bugDescription">
                <div className="bugSeverityIcon"><MdDescription/></div>
                <div className="bugFeatureLocation"><p>{data.bugDescription}</p></div>
            </div>
        ...
        <div className="bugRightPane"> 
            ...
            <div className="bugSeverityIcon"><MdDateRange/></div>
                <div className="bugFeatureLocation"><p>{data.bugReportDate}</p></div>
            </div>
            <div className="bugPriority">
                <div className="bugSeverityIcon"><BiTimer/></div>
                <div className={"bugSeverityLevel "+data.bugPriority.toLowerCase()}>{data.bugPriority}</div>
                
            </div>
            <div className="bugSeverity">
                <div className="bugSeverityIcon"><MdOutlineReportProblem/></div>
                <div className={"bugSeverityLevel "+data.bugSeverity.toLowerCase()}>{data.bugSeverity}</div>
            </div>
            <div className="bugReportedBy">
                ...
                <div className="bugProfileImageContainer">
                    <OverlayTrigger
                        ...
                        >
                        <img className="bugProfileImage" src={`http://localhost:5000/assets/${data.ReportedByUser.imagePath}`}></img>
                    </OverlayTrigger>
                </div>
            </div>
            ...
            <div className="bugSeverityIcon">Assigned to:</div>
                <div className="bugProfileImageContainer">
                    <OverlayTrigger
                        ...
                        >
                        <img className="bugProfileImage" src={`http://localhost:5000/assets/${data.AssignedToUser.imagePath}`}></img>
                    </OverlayTrigger>
                </div>
            </div>
            ...
            <Modal className="bugModal" fade={false} show={editshow} onHide={handleEditClose}>
                    <Modal.Header>
