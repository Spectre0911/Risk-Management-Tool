...
const TableContainer = ({ columns, data, renderRowSubComponent, fetchProjectFunction }) => {
  ...
  return (
    <Fragment>
      ...
      >
        ...
        <Modal.Body>
          <FeatureForm fetchProjectFunction={fetchProjectFunction} handleClose={handleAddClose} />
        </Modal.Body>
      </Modal>
    </Fragment>
  );
