...
(1,1, 'Login Page', 'Add a login page to the project', '2023-03-25 09:00:00', '2023-03-30 18:00:00', false, 3, 2, 1, 10, 0, 2),
(2,1, 'User Dashboard', 'Add a user dashboard page to the project', '2023-03-25 09:00:00', '2023-03-31 18:00:00', false, 5, 1, 2, 30, 0, 3),
(3,1, 'Settings Page', 'Add a settings page to the project', '2023-03-25 09:00:00', '2023-03-29 18:00:00', false, 4, 2, 1, 20, 0, 2),
(4,1, 'User Profiles', 'Add user profiles to the project', '2023-03-26 09:00:00', '2023-04-01 18:00:00', false, 7, 1, 3, 50, 0, 4),
...
(41,1, 'Login page UI', 'Improve the UI design of the login page', '2023-05-11 09:00:00', '2023-05-15 17:00:00', false, 4, 2, 1, 30, 40, 2),
(42,1, 'Registration form validation', 'Implement validation on registration form', '2023-04-16 10:00:00', '2023-04-20 17:00:00', false, 6, 1, 1, 50, 60, 3),
(43,1, 'Password reset functionality', 'Implement password reset functionality', '2023-05-21 09:00:00', '2023-05-26 17:00:00', false,8, 2, 2, 40, 20, 1),
(44,1, 'User profile page to ML', 'Create user profile page with basic information', '2023-04-27 09:00:00', '2023-04-30 17:00:00', false,5, 1, 1, 20, 70, 4),
...
(52,1, 'Login Page UI Design', 'Design a new login page UI for the website', '2023-04-15 09:00:00', '2023-04-20 18:00:00',false, 5, 2, 1, 25, 60,1),
(53,1, 'Add Login Authentication', 'Implement login authentication for users', '2023-04-20 09:00:00', '2023-04-25 18:00:00',false, 7, 1, 1, 50, 20,2),
(54,1, 'Implement User Registration', 'Add functionality for user registration', '2023-04-25 09:00:00', '2023-05-01 18:00:00',false, 6, 1, 1, 30, 40,3),
